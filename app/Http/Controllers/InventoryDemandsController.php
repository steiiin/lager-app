...
/**
 * InventoryDemandsController - controller
 *
 * Controller for InventoryDemands page.
 *
 */
...
class InventoryDemandsController extends Controller
{

  public function index()
  {
    $demands = Demand::all();
    return Inertia::render('InventoryDemands', [
      'demands' => $demands
    ]);
  }
